...
Xs_840  = Xs_msc["842.3"].values
Xs_960  = Xs_msc["953.5"].values
Xs_930  = Xs_msc["929.4"].values
Xs_1025  = Xs_msc["1026.1"].values

ratios = []
for i in range(len(Xs_960)):
    ratio = (Xs_960[i]-8)/(Xs_1025[i]-8) #subtract out dark current
    ratios.append(ratio)
np.array(ratios)
print (ratios)
