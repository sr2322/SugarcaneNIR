...
# Load data
url = 'https://raw.githubusercontent.com/sr2322/mytests/main/TableSugar1_avg_nozeros.csv'
...
ref_url = 'https://raw.githubusercontent.com/sr2322/mytests/main/TableSugar1_avg_nozeros_Refs.csv'
...
with plt.style.context(('ggplot')):
    ...
    plt.axvline(x=740, color = "grey")
    plt.axvline(x=770, color = "grey")
    plt.axvline(x=840, color = "grey")
    plt.axvline(x=910, color = "blue")
    plt.axvline(x=930, color = "blue")
    plt.axvline(x=960, color = "grey")
    plt.axvline(x=970, color = "grey")
    plt.axvline(x=984, color = "grey")
