...
# Load data
url = 'https://raw.githubusercontent.com/sr2322/mytests/main/4.30.21_soaks.csv'
...
ref_url = 'https://raw.githubusercontent.com/sr2322/mytests/main/4.30.21_soaks_ref.csv'
...
Xs_768  = Xs_msc["768.6"].values
Xs_707  = Xs_msc["707.8"].values
Xs_840  = Xs_msc["840.5"].values
Xs_960  = Xs_msc["960.2"].values
Xs_980  = Xs_msc["980.9"].values
Xs_1025  = Xs_msc["1024.5"].values

ratios = []
for i in range(len(Xs_960)):
    ratio = (Xs_840[i])/(Xs_1025[i]) #subtract out dark current
    ratios.append(ratio)
np.array(ratios)
print (ratios)
